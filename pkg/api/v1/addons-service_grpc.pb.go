...
type AddonServiceClient interface {
	// List all Addons
	List(ctx context.Context, in *AddonListRequest, opts ...grpc.CallOption) (*AddonListResponse, error)
	// Create new Addon
...
func (c *addonServiceClient) List(ctx context.Context, in *AddonListRequest, opts ...grpc.CallOption) (*AddonListResponse, error) {
...
type AddonServiceServer interface {
	// List all Addons
	List(context.Context, *AddonListRequest) (*AddonListResponse, error)
	// Create new Addon
...
// UnimplementedAddonServiceServer must be embedded to have forward compatible implementations.
type UnimplementedAddonServiceServer struct {
}

func (UnimplementedAddonServiceServer) List(context.Context, *AddonListRequest) (*AddonListResponse, error) {
...
func _AddonService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddonServiceServer).List(ctx, req.(*AddonListRequest))
	}
...
var AddonService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "v1/addons-service.proto",
}
